...
#载入游戏音乐
pygame.mixer.music.load("/Users/lcy/Downloads/knight.mp3")
...
def About():
    ...
    comeback_rect.left, comeback_rect.top = 900 - 100, 750 - 120
    
    about_font = pygame.font.Font("font/font.TTF", 35)
    Author_text = about_font.render("Author: lichenyu", True, WHITE)
    Email_text = about_font.render("E-mail: 13985418586@163.com", True, WHITE)
    Language_text = about_font.render("Language: Python", True, WHITE)
    Bgm_text = about_font.render("Bgm: 《aLIEz》《希德尼亚的骑士》", True, WHITE)
    #This book is for academic exchanges and research learning, Do not used for commercial purposes. 
    Attention1_text = about_font.render("Attention: 这个游戏仅供研究学习 ", True, WHITE)
    Attention2_text = about_font.render("希望不要商业化使用", True, WHITE)
    Attention3_text = about_font.render("谢谢", True, WHITE)
...
def Help():
    ...
    comeback_img = comeback1_img#设置默认图片
    comeback_rect = comeback1_img.get_rect()
    comeback_rect.left, comeback_rect.top = 900 - 100, 750 - 100
...
def Menu():
    ...
    begin_game_rect.left, begin_game_rect.top = 350, 486 - 300
    ...
    help_rect.left, help_rect.top = 350, 486 -150
    ...
    about_rect.left, about_rect.top =  350, 486
...
def main():
    ...
    gameover_rect.left, gameover_rect.top = 318 + 65, 424 + 300
    ...
    comeback_img = comeback1_img#设置默认图片
    comeback_rect = comeback1_img.get_rect()
    comeback_rect.left, comeback_rect.top = 901 - 100, 750 - 150
